...
function addToMailingList() {
  const container =
    document.querySelector(
      '.mailing-list'
    ); /*select the element that will contain the new element*/
  const email_form =
    document.createElement('form'); /*create the new element to be added*/

  email_form.style.padding = '2em';
  email_form.style.display = 'flex';
  email_form.style.justifyContent = 'space-around';

  const email_fieldset =
    document.createElement('fieldset'); /*create the new element to be added*/
  ...
  const email_legend =
    document.createElement('legend'); /*create the new element to be added*/
  email_legend.innerText = 'Enter email';

  const email_input =
    document.createElement('input'); /*create the new element to be added*/
  ...
  email_fieldset.appendChild(
    email_legend
  ); /*add the new legend to the fieldset*/
